# Contributing to Conjugate-Android

Thank you for your interest in contributing!

Please take a moment to review this document in order to make the contribution process easy and effective for everyone involved.

Following these guidelines helps to communicate that you respect the time of the developers managing and developing this open-source project. In return, and in accordance with this project's [code of conduct](https://github.com/scribe-org/Conjugate-Android/blob/main/.github/CODE_OF_CONDUCT.md), other contributors will reciprocate that respect in addressing your issue or assessing changes and features.
...
Thank you for your interest in contributing to Conjugate-Android! We look forward to welcoming you to the community and working with you to build an tools for language learners to communicate effectively :) The following are some suggested steps for people interested in joining our community:
...
-   Look into issues marked [`good first issue`](https://github.com/scribe-org/Conjugate-Android/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22) and the [Projects board](https://github.com/orgs/scribe-org/projects/1) to get a better understanding of what you can work on
...
>
> -   e.g. Cloning now becomes `git clone git@github.com:<your-username>/Conjugate-Android.git`
>
...
git clone https://github.com/<your-username>/Conjugate-Android.git
# Navigate to the newly cloned directory.
cd Conjugate-Android
# Assign the original repo to a remote called "upstream".
git remote add upstream https://github.com/scribe-org/Conjugate-Android.git
```

-   Now, if you run `git remote -v` you should see two remote repositories named:
    -   `origin` (forked repository)
    -   `upstream` (Conjugate-Android repository)

3. Open the Conjugate-Android directory in Android Studio

4. In order to [run Conjugate on an emulator](https://developer.android.com/studio/run/emulator):
...
Conjugate-Android uses pre-commit hooks to maintain a clean and consistent codebase. These hooks help automatically check for issues such as formatting, trailing whitespace, and linting errors. Here's how to set up pre-commit for Conjugate-Android:
...
In addition to the [pre-commit](https://pre-commit.com/) hooks that are set up during the [development environment section](#dev-env), Conjugate-Android includes a testing suite that should be ran before all pull requests and subsequent commits.
...
### Unit Testing Conventions for Conjugate-Android

To maintain consistency and clarity in the Conjugate-Android codebase, we recommend you to follow these conventions when writing unit tests. These guidelines cover the organization, naming conventions, scope, and structure for unit tests.
...
The [issue tracker for Conjugate-Android](https://github.com/scribe-org/Conjugate-Android/issues) is the preferred channel for [bug reports](#bug-reports), [features requests](#feature-requests) and [submitting pull requests](#pull-requests). Scribe also organizes related issues into [projects](https://github.com/scribe-org/Conjugate-Android/projects).

> [!NOTE]\
> Just because an issue is assigned on GitHub doesn't mean that the team isn't interested in your contribution! Feel free to write [in the issues](https://github.com/scribe-org/Conjugate-Android/issues) and we can potentially reassign it to you.

Be sure to check the [`-next release-`](https://github.com/scribe-org/Conjugate-Android/labels/-next%20release-) and [`-priority-`](https://github.com/scribe-org/Conjugate-Android/labels/-priority-) labels in the [issues](https://github.com/scribe-org/Conjugate-Android/issues) for those that are most important, as well as those marked [`good first issue`](https://github.com/scribe-org/Conjugate-Android/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) that are tailored for first time contributors.
...
To make the above steps easier, the Conjugate team asks that contributors report bugs using the [bug report](https://github.com/scribe-org/Conjugate-Android/issues/new?assignees=&labels=feature&template=bug_report.yml) template, with these issues further being marked with the [`bug`](https://github.com/scribe-org/Conjugate-Android/issues?q=is%3Aopen+is%3Aissue+label%3Abug) label.
...
Feature requests are more than welcome! Please take a moment to find out whether your idea fits with the scope and aims of the project. When making a suggestion, provide as much detail and context as possible, and further make clear the degree to which you would like to contribute in its development. Feature requests are marked with the [`feature`](https://github.com/scribe-org/Conjugate-Android/issues?q=is%3Aopen+is%3Aissue+label%3Afeature) label, and can be made using the [feature request](https://github.com/scribe-org/Conjugate-Android/issues/new?assignees=&labels=feature&template=feature_request.yml) template.

<a id="pull-requests"></a>

# Pull requests [`⇧`](#contents)

Good pull requests - patches, improvements and new features - are the foundation of our community making Conjugate-Android. They should remain focused in scope and avoid containing unrelated commits. Note that all contributions to this project will be made under [the specified license](https://github.com/scribe-org/Conjugate-Android/blob/main/LICENSE.txt) and should follow the coding indentation and style standards ([contact us](https://matrix.to/#/#scribe_community:matrix.org) if unsure).
...
Please run the [update_i18n_keys.sh](https://github.com/scribe-org/Conjugate-Android/blob/main/update_i18n_keys.sh) script to load in the most recent version of the [Scribe-i18n](https://github.com/scribe-org/Scribe-i18n) app texts into Conjugate-Android.
...
Documentation is an invaluable way to contribute to coding projects as it allows others to more easily understand the project structure and contribute. Issues related to documentation are marked with the [`documentation`](https://github.com/scribe-org/Conjugate-Android/labels/documentation) label.
...
Designs for Scribe are done in the [public design file in Figma](https://www.figma.com/file/c8945w2iyoPYVhsqW7vRn6/scribe_public_designs?node-id=405%3A464). Those interested in helping with Scribe's design are also welcome to share their ideas using the [design improvement](https://github.com/scribe-org/Conjugate-Android/issues/new?assignees=&labels=design&template=design_improvement.yml) template that makes an issue marked with the [`design`](https://github.com/scribe-org/Conjugate-Android/issues?q=is%3Aopen+is%3Aissue+label%3Adesign) label.
